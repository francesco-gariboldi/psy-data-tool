...
# Arbitrary objects may be stored using the object dtype, but should be
# avoided to the extent possible (for performance and interoperability with
# other libraries and methods. This function should avoid them.
# This function should also avoid unbalanced situations.
